        ...
        return (
            <div className="dash-nav dash-nav-dark">
                <header>
                    ...
                    <a href="index.html" className="easion-logo"><i className="fas fa-sun" /> <span>Easion</span></a>
                </header>
                <nav className="dash-nav-list">
                    <a href="index.html" className="dash-nav-item">
                    <i className="fas fa-home" /> Dashboard </a>
                    ...
                    <div className="dash-nav-dropdown-menu">
                        <a href="https://github.com/subet/easion" target="_blank" className="dash-nav-dropdown-item">GitHub</a>
                        <a href="https://usebootstrap.com/theme/easion" target="_blank" className="dash-nav-dropdown-item">UseBootstrap</a>
                        <a href="https://mudimedia.com" target="_blank" className="dash-nav-dropdown-item">Mudimedia Software</a>
                    </div>
                    </div>
                </nav>
            </div>
