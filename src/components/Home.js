                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-md-6 col-lg-4">
                                                    ...
                                                    <div className="form-group">
                                                        <div className="input-group">
                                                            <div className="input-group-prepend">
                                                                <button className="btn btn-default btn-border" type="button">Button</button>
                                                            </div>
                                                    ...
                                                    <div className="form-group">
                                                        <div className="input-group">
                                                            ...
                                                            <div className="input-group-append">
                                                                <button className="btn btn-primary btn-border dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
                                                        ...
                                                        <div className="row gutters-xs">
                                                            <div className="col-auto">
                                                                <label className="colorinput">
                                                                    ...
                                                                    <span className="colorinput-color bg-dark" />
                                                                </label>
                                                            </div>
                                                            <div className="col-auto">
                                                                <label className="colorinput">
                                                ...
                                                <div className="col-md-6 col-lg-4">
                                                    ...
                                                    <div className="form-group form-group-default">
                                                        <label>Select</label>
                                                        <select className="form-control" id="formGroupDefaultSelect">
                                                            <option>1</option>
                                                            <option>2</option>
                                                            <option>3</option>
                                                            <option>4</option>
                                                    ...
                                                    <div className="form-group form-floating-label">
                                                        <input id="inputFloatingLabel" type="text" className="form-control input-border-bottom" required />
                                                        <label htmlFor="inputFloatingLabel" className="placeholder">Input</label>
                                                    </div>
                                                    <div className="form-group form-floating-label">
                                                        <select className="form-control input-border-bottom" id="selectFloatingLabel" required>
                                                            <option value>&nbsp;</option>
                                                            <option>1</option>
                                                            <option>2</option>
                                                            <option>3</option>
                                                        ...
                                                        <label htmlFor="selectFloatingLabel" className="placeholder">Select</label>
                                                    </div>
                                                    <div className="form-group form-floating-label">
                                                        <input id="inputFloatingLabel2" type="text" className="form-control input-solid" required />
                                                        <label htmlFor="inputFloatingLabel2" className="placeholder">Input</label>
                                                    </div>
                                                    <div className="form-group form-floating-label">
                                                        <select className="form-control input-solid" id="selectFloatingLabel2" required>
                                                            <option value>&nbsp;</option>
                                                            <option>1</option>
                                                            <option>2</option>
                                                            <option>3</option>
                                                        ...
                                                        <label htmlFor="selectFloatingLabel2" className="placeholder">Select</label>
                                                    </div>
                                                    <div className="form-group">
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <select className="form-control form-control-lg" id="largeSelect">
                                                            <option>1</option>
                                                            <option>2</option>
                                                            <option>3</option>
                                                            <option>4</option>
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <select className="form-control form-control" id="defaultSelect">
                                                            <option>1</option>
                                                            <option>2</option>
                                                            <option>3</option>
                                                            <option>4</option>
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <select className="form-control form-control-sm" id="smallSelect">
                                                            <option>1</option>
                                                            <option>2</option>
                                                            <option>3</option>
                                                            <option>4</option>
